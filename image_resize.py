...
def parse_args():
    ...
    parser.add_argument('-width', '--width', default=None, type=validate_size, dest="width",
                        help='set image width (integer>0)')
    parser.add_argument('-height', '--height', default=None, type=validate_size, dest="height",
